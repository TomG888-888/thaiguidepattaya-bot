...
TOUR_CATALOG = {
    ...
    "samet_transfer": make_tour(
        ...
        price_adult=None,
        price_child=None,
        price_from="1300 THB за человека, туда и обратно",
    ...
    "transfer_bkk_airport_pattaya": make_tour(
        ...
        price_child=None,
        price_from=(
            "Суварнабхуми — Паттайя: 1300 THB за седан до 4 человек. "
            "Дон Муанг — Паттайя: 1600 THB за седан до 4 человек. "
            "Платные дороги оплачиваются отдельно по тарифам."
        ),
    ...
    "transfer_pattaya_bkk_airport": make_tour(
        ...
        price_child=None,
        price_from=(
            "Паттайя — Суварнабхуми: 1300 THB за седан до 4 человек. "
            "Паттайя — Дон Муанг: 1600 THB за седан до 4 человек. "
            "Платные дороги оплачиваются отдельно по тарифам."
        ),
    ...
    "chang": make_tour(
        ...
        price_adult="5100 THB",
        price_child="детский уточняется",
